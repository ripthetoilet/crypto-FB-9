...
def bigram(alphabet,text):
    ...
    for i in range(1,len(matrix[0])):
        for j in range(1,len(matrix[0])):
            ...
            matrix[i][j]= ('{:.5f}'.format(text.count(big)/len_text))
...
print()
bigram(alphabetWithSpaces,textWithSpaces)
print()
letters(alphabetWithoutSpaces,textWithoutSpaces)
print()
bigram(alphabetWithoutSpaces,textWithoutSpaces)