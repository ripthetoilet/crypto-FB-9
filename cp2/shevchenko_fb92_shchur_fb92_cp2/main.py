...
def Random_word(length):
    ...
    for i in range(length):
        word = word + Int_char(random.randint(0, 31))
    return word
...
TEXT_PLAIN_TASK1 = 'plain\\song.txt'
TEXT_THEORETICAL = 'plain\\tank.txt'
...
print('Індекс відповідності відкритого тексту: ', Get_index(plain))
index_theoretical = Get_index(Clear_text(Read_text(TEXT_THEORETICAL)))
